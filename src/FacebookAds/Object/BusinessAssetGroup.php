...
class BusinessAssetGroup extends AbstractCrudObject {
  ...
  public static function getFieldsEnum() {
    return BusinessAssetGroupFields::getInstance();
  }

  protected static function getReferencedEnums() {
    $ref_enums = array();
    $ref_enums['AdaccountTasks'] = BusinessAssetGroupAdaccountTasksValues::getInstance()->getValues();
    $ref_enums['OfflineConversionDataSetTasks'] = BusinessAssetGroupOfflineConversionDataSetTasksValues::getInstance()->getValues();
    $ref_enums['PageTasks'] = BusinessAssetGroupPageTasksValues::getInstance()->getValues();
    $ref_enums['PixelTasks'] = BusinessAssetGroupPixelTasksValues::getInstance()->getValues();
    return $ref_enums;
  }
  ...
  public function createAssignedUser(array $fields = array(), array $params = array(), $pending = false) {
    ...
    $enums = array(
      'adaccount_tasks_enum' => BusinessAssetGroupAdaccountTasksValues::getInstance()->getValues(),
      'offline_conversion_data_set_tasks_enum' => BusinessAssetGroupOfflineConversionDataSetTasksValues::getInstance()->getValues(),
      'page_tasks_enum' => BusinessAssetGroupPageTasksValues::getInstance()->getValues(),
      'pixel_tasks_enum' => BusinessAssetGroupPixelTasksValues::getInstance()->getValues(),
    );

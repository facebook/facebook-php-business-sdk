...
class AdsInsightsFields extends AbstractEnum {
  ...
  const PRODUCT_CONTENT_ID = 'product_content_id';
  const PRODUCT_CUSTOM_LABEL_0 = 'product_custom_label_0';
  const PRODUCT_CUSTOM_LABEL_1 = 'product_custom_label_1';
  const PRODUCT_CUSTOM_LABEL_2 = 'product_custom_label_2';
  const PRODUCT_CUSTOM_LABEL_3 = 'product_custom_label_3';
  const PRODUCT_CUSTOM_LABEL_4 = 'product_custom_label_4';
  const PRODUCT_GROUP_CONTENT_ID = 'product_group_content_id';
  ...
  public function getFieldTypes() {
    return array(
      ...
      'product_custom_label_0' => 'string',
      'product_custom_label_1' => 'string',
      'product_custom_label_2' => 'string',
      'product_custom_label_3' => 'string',
      'product_custom_label_4' => 'string',

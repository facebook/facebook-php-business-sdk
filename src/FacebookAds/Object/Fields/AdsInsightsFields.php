...
class AdsInsightsFields extends AbstractEnum {
  ...
  const CLICKS = 'clicks';
  const CONFIGURABLE_ATTRIBUTION_ACTION = 'configurable_attribution_action';
  const CONFIGURABLE_ATTRIBUTION_ACTIONVALUE = 'configurable_attribution_actionvalue';
  const CONFIGURABLE_AUDIENCE_OVERLAP_REACH = 'configurable_audience_overlap_reach';
  const CONFIGURABLE_AUDIENCE_OVERLAP_WITH_CONV_ACTION = 'configurable_audience_overlap_with_conv_action';
  const CONFIGURABLE_AUDIENCE_OVERLAP_WITH_CONV_CONVERTERS = 'configurable_audience_overlap_with_conv_converters';
  const CONFIGURABLE_AUDIENCE_OVERLAP_WITH_CONV_EXPOSURE_COST = 'configurable_audience_overlap_with_conv_exposure_cost';
  const CONFIGURABLE_AUDIENCE_OVERLAP_WITH_CONV_EXPOSURE_IMPRESSIONS = 'configurable_audience_overlap_with_conv_exposure_impressions';
  const CONFIGURABLE_AUDIENCE_OVERLAP_WITH_CONV_EXPOSURE_REACH = 'configurable_audience_overlap_with_conv_exposure_reach';
  const CONFIGURABLE_PLACEMENT_PTC_CONVERSIONS = 'configurable_placement_ptc_conversions';
  const CONFIGURABLE_PLACEMENT_PTC_CONVERTERS = 'configurable_placement_ptc_converters';
  const CONFIGURABLE_PLACEMENT_PTC_REACH = 'configurable_placement_ptc_reach';
  const CONFIGURABLE_REACHBYFREQUENCY_ACTION = 'configurable_reachbyfrequency_action';
  const CONFIGURABLE_REACHBYFREQUENCY_CONVERTERS_COUNT = 'configurable_reachbyfrequency_converters_count';
  const CONFIGURABLE_REACHBYFREQUENCY_IMPRESSIONS_COST = 'configurable_reachbyfrequency_impressions_cost';
  const CONFIGURABLE_REACHBYFREQUENCY_IMPRESSIONS_COUNT = 'configurable_reachbyfrequency_impressions_count';
  const CONFIGURABLE_REACHBYFREQUENCY_REACH = 'configurable_reachbyfrequency_reach';
  ...
  const CONVERTED_PRODUCT_APP_CUSTOM_EVENT_FB_MOBILE_PURCHASE = 'converted_product_app_custom_event_fb_mobile_purchase';
  const CONVERTED_PRODUCT_APP_CUSTOM_EVENT_FB_MOBILE_PURCHASE_VALUE = 'converted_product_app_custom_event_fb_mobile_purchase_value';
  const CONVERTED_PRODUCT_OFFLINE_PURCHASE = 'converted_product_offline_purchase';
  const CONVERTED_PRODUCT_OFFLINE_PURCHASE_VALUE = 'converted_product_offline_purchase_value';
  const CONVERTED_PRODUCT_OMNI_PURCHASE = 'converted_product_omni_purchase';
  const CONVERTED_PRODUCT_OMNI_PURCHASE_VALUES = 'converted_product_omni_purchase_values';
  const CONVERTED_PRODUCT_QUANTITY = 'converted_product_quantity';
  const CONVERTED_PRODUCT_VALUE = 'converted_product_value';
  const CONVERTED_PRODUCT_WEBSITE_PIXEL_PURCHASE = 'converted_product_website_pixel_purchase';
  const CONVERTED_PRODUCT_WEBSITE_PIXEL_PURCHASE_VALUE = 'converted_product_website_pixel_purchase_value';
  const CONVERTED_PROMOTED_PRODUCT_APP_CUSTOM_EVENT_FB_MOBILE_PURCHASE = 'converted_promoted_product_app_custom_event_fb_mobile_purchase';
  const CONVERTED_PROMOTED_PRODUCT_APP_CUSTOM_EVENT_FB_MOBILE_PURCHASE_VALUE = 'converted_promoted_product_app_custom_event_fb_mobile_purchase_value';
  const CONVERTED_PROMOTED_PRODUCT_OFFLINE_PURCHASE = 'converted_promoted_product_offline_purchase';
  const CONVERTED_PROMOTED_PRODUCT_OFFLINE_PURCHASE_VALUE = 'converted_promoted_product_offline_purchase_value';
  const CONVERTED_PROMOTED_PRODUCT_OMNI_PURCHASE = 'converted_promoted_product_omni_purchase';
  const CONVERTED_PROMOTED_PRODUCT_OMNI_PURCHASE_VALUES = 'converted_promoted_product_omni_purchase_values';
  ...
  const CONVERTED_PROMOTED_PRODUCT_WEBSITE_PIXEL_PURCHASE = 'converted_promoted_product_website_pixel_purchase';
  const CONVERTED_PROMOTED_PRODUCT_WEBSITE_PIXEL_PURCHASE_VALUE = 'converted_promoted_product_website_pixel_purchase_value';
  ...
  const COST_PER_6_SEC_VIDEO_VIEW = 'cost_per_6_sec_video_view';
  ...
  const COST_PER_MESSAGE_DELIVERED = 'cost_per_message_delivered';
  const COST_PER_OBJECTIVE_RESULT = 'cost_per_objective_result';
  ...
  const MARKETING_MESSAGES_READ_RATE_BENCHMARK = 'marketing_messages_read_rate_benchmark';
  ...
  const OPPORTUNITY_SCORE_L4 = 'opportunity_score_l4';
  ...
  const VIDEO_6_SEC_WATCHED_ACTIONS = 'video_6_sec_watched_actions';

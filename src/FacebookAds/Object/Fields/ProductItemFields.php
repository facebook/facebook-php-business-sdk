...
class ProductItemFields extends AbstractEnum {
  ...
  const AFFILIATE_SELLER_RATING = 'affiliate_seller_rating';
  const AFFILIATE_SELLER_RATING_COUNT = 'affiliate_seller_rating_count';
  ...
  const CATEGORY_RANKING = 'category_ranking';

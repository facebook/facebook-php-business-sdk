...
class ProductFeedAppsAndSoftwareGet extends AbstractObject {

  /**
   * @return ProductFeedAppsAndSoftwareGetFields
   */
  public static function getFieldsEnum() {
    return ProductFeedAppsAndSoftwareGetFields::getInstance();
  }

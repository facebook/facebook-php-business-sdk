...
class WhatsAppBusinessPartnerClientVerificationSubmission extends AbstractCrudObject {

  /**
   * @return WhatsAppBusinessPartnerClientVerificationSubmissionFields
   */
  public static function getFieldsEnum() {
    return WhatsAppBusinessPartnerClientVerificationSubmissionFields::getInstance();
  }

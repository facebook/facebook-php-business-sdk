...
use FacebookAds\Object\Fields\CustomAudienceDataSourceFields;
use FacebookAds\Object\Values\CustomAudienceDataSourceSubTypeValues;
...
class CustomAudienceDataSource extends AbstractCrudObject {
  ...
  public function getSelf(array $fields = array(), array $params = array(), $pending = false) {
    ...
    $request = new ApiRequest(
      ...
      '/',
      new CustomAudienceDataSource(),
      'NODE',
      CustomAudienceDataSource::getFieldsEnum()->getValues(),

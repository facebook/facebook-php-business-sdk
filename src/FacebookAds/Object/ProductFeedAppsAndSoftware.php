...
class ProductFeedAppsAndSoftware extends AbstractCrudObject {

  /**
   * @return ProductFeedAppsAndSoftwareFields
   */
  public static function getFieldsEnum() {
    return ProductFeedAppsAndSoftwareFields::getInstance();
  }
  ...
  public function genget(array $fields = array(), array $params = array(), $pending = false) {
    ...
    $request = new ApiRequest(
      ...
      '/apps_and_software',
      new ProductFeedAppsAndSoftwareGet(),
      'EDGE',
      ProductFeedAppsAndSoftwareGet::getFieldsEnum()->getValues(),

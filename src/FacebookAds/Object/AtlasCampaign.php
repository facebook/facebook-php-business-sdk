...
class AtlasCampaign extends AbstractCrudObject {
  ...
  public function getInvoices(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getTraffickingData(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();

...
use FacebookAds\Object\Fields\MeasurementReportFields;
...
class MeasurementReport extends AbstractCrudObject {
  ...
  public static function getFieldsEnum() {
    return MeasurementReportFields::getInstance();
  }

  protected static function getReferencedEnums() {
    $ref_enums = array();
    $ref_enums['ReportType'] = MeasurementReportReportTypeValues::getInstance()->getValues();
    return $ref_enums;
  }

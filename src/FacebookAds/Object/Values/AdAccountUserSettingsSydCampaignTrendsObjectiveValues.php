 ...
 *
 * @method static AdAccountUserSettingsSydCampaignTrendsObjectiveValues getInstance()
 */
class AdAccountUserSettingsSydCampaignTrendsObjectiveValues extends AbstractEnum {

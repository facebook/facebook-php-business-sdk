 ...
 *
 * @method static AdAccountMatchedSearchApplicationsEdgeDataStoresToFilterValues getInstance()
 */
class AdAccountMatchedSearchApplicationsEdgeDataStoresToFilterValues extends AbstractEnum {

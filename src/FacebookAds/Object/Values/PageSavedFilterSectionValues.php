...
class PageSavedFilterSectionValues extends AbstractEnum {
  ...
  const CAMPAIGN_CENTER = 'CAMPAIGN_CENTER';
  ...
  const COMMERCE_DISCOUNT_CODES = 'COMMERCE_DISCOUNT_CODES';
  ...
  const TAROT_COMPOSER = 'TAROT_COMPOSER';
  const DRAFT_EDITIONS = 'DRAFT_EDITIONS';
  const PUBLISHED_EDITIONS = 'PUBLISHED_EDITIONS';
  ...
  const BRAND_ASSET_LIBRARY = 'BRAND_ASSET_LIBRARY';

 ...
 *
 * @method static AdCreativeGetCallToActionTypeValues getInstance()
 */
class AdCreativeGetCallToActionTypeValues extends AbstractEnum {

  const ACTIVATE_OFFER = 'ACTIVATE_OFFER';
  ...
  const BET_NOW = 'BET_NOW';
  const BLOOD_DONATIONS = 'BLOOD_DONATIONS';
  const BOOK_A_CONSULTATION = 'BOOK_A_CONSULTATION';
  const BOOK_NOW = 'BOOK_NOW';
  const BOOK_TEST_DRIVE = 'BOOK_TEST_DRIVE';
  ...
  const EXPLORE_MORE = 'EXPLORE_MORE';
  ...
  const GET_MOBILE_APP = 'GET_MOBILE_APP';
  ...
  const GIVE_FREE_RIDES = 'GIVE_FREE_RIDES';
  const GO_LIVE = 'GO_LIVE';
  const IMAGINE = 'IMAGINE';
  const INQUIRE_NOW = 'INQUIRE_NOW';
  const INSTAGRAM_MESSAGE = 'INSTAGRAM_MESSAGE';
  const INSTALL_APP = 'INSTALL_APP';
  const INSTALL_FREE_MOBILE_APP = 'INSTALL_FREE_MOBILE_APP';
  const INSTALL_MOBILE_APP = 'INSTALL_MOBILE_APP';
  const INTERESTED = 'INTERESTED';
  const JOBS_APPLY_NOW = 'JOBS_APPLY_NOW';
  ...
  const LINK_CARD = 'LINK_CARD';
  const LISTEN_MUSIC = 'LISTEN_MUSIC';
  const LISTEN_NOW = 'LISTEN_NOW';
  const LOYALTY_LEARN_MORE = 'LOYALTY_LEARN_MORE';
  ...
  const OPEN_MESSENGER_EXT = 'OPEN_MESSENGER_EXT';
  const OPEN_MOVIES = 'OPEN_MOVIES';
  const ORDER_NOW = 'ORDER_NOW';
  const PAY_OR_REQUEST = 'PAY_OR_REQUEST';
  ...
  const TRY_IN_CAMERA = 'TRY_IN_CAMERA';
  const TRY_IT = 'TRY_IT';
  const TRY_NOW = 'TRY_NOW';
  const TRY_ON = 'TRY_ON';
  const TRY_ON_WITH_AI = 'TRY_ON_WITH_AI';
  const UNLIKE_PAGE = 'UNLIKE_PAGE';
  ...
  const VIEW_INSTAGRAM_PROFILE = 'VIEW_INSTAGRAM_PROFILE';
  ...
  const VISIT_WORLD = 'VISIT_WORLD';
  const VOTE_NOW = 'VOTE_NOW';
  const WATCH_APP_UPGRADE = 'WATCH_APP_UPGRADE';
  const WATCH_LIVE_VIDEO = 'WATCH_LIVE_VIDEO';
  const WATCH_MORE = 'WATCH_MORE';
  const WATCH_MUSIC_VIDEO = 'WATCH_MUSIC_VIDEO';

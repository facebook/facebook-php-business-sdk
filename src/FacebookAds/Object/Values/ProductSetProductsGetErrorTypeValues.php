 ...
 *
 * @method static ProductSetProductsGetErrorTypeValues getInstance()
 */
class ProductSetProductsGetErrorTypeValues extends AbstractEnum {
  ...
  const INACTIVE_MAGENTO_PRODUCT = 'INACTIVE_MAGENTO_PRODUCT';
  const INACTIVE_SALESFORCE_COMMERCE_CLOUD_PRODUCT = 'INACTIVE_SALESFORCE_COMMERCE_CLOUD_PRODUCT';
  const INACTIVE_SHOPIFY_PRODUCT = 'INACTIVE_SHOPIFY_PRODUCT';
  const INACTIVE_WOOCOMMERCE_PRODUCT = 'INACTIVE_WOOCOMMERCE_PRODUCT';
  const INVALID_COMMERCE_TAX_CATEGORY = 'INVALID_COMMERCE_TAX_CATEGORY';
  const INVALID_COMSCORE_MARKET_CODES = 'INVALID_COMSCORE_MARKET_CODES';
  ...
  const INVALID_SALE_PRICE = 'INVALID_SALE_PRICE';
  ...
  const ITEM_WITHOUT_VIDEO = 'ITEM_WITHOUT_VIDEO';
  const MARKETPLACE_DISABLED_BY_USER = 'MARKETPLACE_DISABLED_BY_USER';
  const MARKETPLACE_NOT_SHIPPED_ITEM = 'MARKETPLACE_NOT_SHIPPED_ITEM';
  ...
  const MARKETPLACE_PARTNER_DISTRIBUTION_DISABLED = 'MARKETPLACE_PARTNER_DISTRIBUTION_DISABLED';
  ...
  const MARKETPLACE_SHIPPED_ITEM_EXPIRED = 'MARKETPLACE_SHIPPED_ITEM_EXPIRED';
  const MARKETPLACE_SHIPPED_ITEM_NOT_AVAILABLE = 'MARKETPLACE_SHIPPED_ITEM_NOT_AVAILABLE';
  const MARKETPLACE_SHIPPED_SELLER_FEATURE_BANNED = 'MARKETPLACE_SHIPPED_SELLER_FEATURE_BANNED';
  const MARKETPLACE_SHIPPED_SELLER_NOT_FULLY_ONBOARDED = 'MARKETPLACE_SHIPPED_SELLER_NOT_FULLY_ONBOARDED';
  ...
  const RETAILER_ID_USED_BY_GROUP = 'RETAILER_ID_USED_BY_GROUP';
  const SHOPIFY_INVALID_RETAILER_ID = 'SHOPIFY_INVALID_RETAILER_ID';
  const SHOPIFY_ITEM_MISSING_DELIVERY_PROFILE_ZERO_INVENTORY = 'SHOPIFY_ITEM_MISSING_DELIVERY_PROFILE_ZERO_INVENTORY';
  ...
  const TOP_PRODUCT_WITHOUT_VIDEOS = 'TOP_PRODUCT_WITHOUT_VIDEOS';
  ...
  const VIDEO_FETCH_FAILED_RATE_LIMITED = 'VIDEO_FETCH_FAILED_RATE_LIMITED';
  const VIDEO_FETCH_FAILED_SERVER_ERROR = 'VIDEO_FETCH_FAILED_SERVER_ERROR';
  const VIDEO_FETCH_FAILED_TIMED_OUT = 'VIDEO_FETCH_FAILED_TIMED_OUT';
  const VIDEO_ISSUE_GENERIC = 'VIDEO_ISSUE_GENERIC';

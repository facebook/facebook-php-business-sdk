 ...
 *
 * @method static AdAccountDefaultObjectiveDefaultObjectiveForUserValues getInstance()
 */
class AdAccountDefaultObjectiveDefaultObjectiveForUserValues extends AbstractEnum {

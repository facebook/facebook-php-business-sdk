 ...
 *
 * @method static AdAccountOptimizationGoalsAEMv2EligibilityOptimizationGoalValues getInstance()
 */
class AdAccountOptimizationGoalsAEMv2EligibilityOptimizationGoalValues extends AbstractEnum {
  ...
  const ENGAGED_PAGE_VIEWS = 'ENGAGED_PAGE_VIEWS';
  ...
  const MESSAGING_DEEP_CONVERSATION_AND_FOLLOW = 'MESSAGING_DEEP_CONVERSATION_AND_FOLLOW';

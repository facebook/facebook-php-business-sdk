 ...
 *
 * @method static ProductCatalogLocalizedItemsBatchPostItemSubTypeValues getInstance()
 */
class ProductCatalogLocalizedItemsBatchPostItemSubTypeValues extends AbstractEnum {

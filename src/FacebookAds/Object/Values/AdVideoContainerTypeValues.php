...
class AdVideoContainerTypeValues extends AbstractEnum {
  ...
  const AI_INTERACTIVE_EMBODIMENT = 'AI_INTERACTIVE_EMBODIMENT';
  ...
  const CREATOR_FAN_CHALLENGE = 'CREATOR_FAN_CHALLENGE';
  const CREATOR_STOREFRONT_PERSONALIZED_VIDEO = 'CREATOR_STOREFRONT_PERSONALIZED_VIDEO';
  const CREATOR_STOREFRONT_PROMOTIONAL_VIDEO = 'CREATOR_STOREFRONT_PROMOTIONAL_VIDEO';
  ...
  const DOUBLE_PROD_EXPERIMENT = 'DOUBLE_PROD_EXPERIMENT';
  ...
  const FB_MSGR_STATUS_MEDIA_ELEMENT = 'FB_MSGR_STATUS_MEDIA_ELEMENT';
  const FB_QUICKSNAP_VIDEO = 'FB_QUICKSNAP_VIDEO';
  ...
  const MUSIC_CLIP_IN_FB_MSGR_STATUS = 'MUSIC_CLIP_IN_FB_MSGR_STATUS';
  const MUSIC_CLIP_IN_LIGHTWEIGHT_STATUS = 'MUSIC_CLIP_IN_LIGHTWEIGHT_STATUS';
  const MUSIC_CLIP_IN_MAPLE_POST = 'MUSIC_CLIP_IN_MAPLE_POST';
  ...
  const TEMP_VIDEO_COPYRIGHT_SCAN = 'TEMP_VIDEO_COPYRIGHT_SCAN';

...
class AdVideoContainerTypeValues extends AbstractEnum {
  ...
  const COPYRIGHT_REFERENCE_IG_XPOST_VIDEO = 'COPYRIGHT_REFERENCE_IG_XPOST_VIDEO';
  const COPYRIGHT_REFERENCE_VIDEO = 'COPYRIGHT_REFERENCE_VIDEO';
  const CREATION_ML_PRECREATION = 'CREATION_ML_PRECREATION';
  const CREATOR_STOREFRONT_PERSONALIZED_VIDEO = 'CREATOR_STOREFRONT_PERSONALIZED_VIDEO';
  const DATAGENIX_VIDEO = 'DATAGENIX_VIDEO';
  ...
  const FB_SHORTS_LINKED_PRODUCT = 'FB_SHORTS_LINKED_PRODUCT';
  ...
  const MUSIC_CLIP_IN_MSGR_NOTE = 'MUSIC_CLIP_IN_MSGR_NOTE';
  ...
  const ORIGINALITY_SELF_ADVOCACY = 'ORIGINALITY_SELF_ADVOCACY';

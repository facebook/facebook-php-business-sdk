...
class AdPreviewAdFormatValues extends AbstractEnum {
  ...
  const FACEBOOK_IFU_REELS_MOBILE = 'FACEBOOK_IFU_REELS_MOBILE';
  ...
  const FACEBOOK_REELS_BANNER_FEED_ANDROID = 'FACEBOOK_REELS_BANNER_FEED_ANDROID';
  const FACEBOOK_REELS_BANNER_FEED_ANDROID_LARGE = 'FACEBOOK_REELS_BANNER_FEED_ANDROID_LARGE';
  const FACEBOOK_REELS_BANNER_FULLSCREEN_IOS = 'FACEBOOK_REELS_BANNER_FULLSCREEN_IOS';
  const FACEBOOK_REELS_BANNER_FULLSCREEN_MOBILE = 'FACEBOOK_REELS_BANNER_FULLSCREEN_MOBILE';
  const FACEBOOK_REELS_MOBILE = 'FACEBOOK_REELS_MOBILE';
  const FACEBOOK_REELS_POSTLOOP = 'FACEBOOK_REELS_POSTLOOP';
  const FACEBOOK_REELS_POSTLOOP_FEED = 'FACEBOOK_REELS_POSTLOOP_FEED';
  const FACEBOOK_REELS_SIMILAR_PRODUCTS_MOBILE = 'FACEBOOK_REELS_SIMILAR_PRODUCTS_MOBILE';
  ...
  const INSTAGRAM_REELS_WEB = 'INSTAGRAM_REELS_WEB';
  const INSTAGRAM_REELS_WEB_M_SITE = 'INSTAGRAM_REELS_WEB_M_SITE';
  ...
  const INSTREAM_BANNER_FEED_IOS = 'INSTREAM_BANNER_FEED_IOS';
  const INSTREAM_BANNER_FULLSCREEN_IOS = 'INSTREAM_BANNER_FULLSCREEN_IOS';
  ...
  const WHATSAPP_STATUS_MEDIA = 'WHATSAPP_STATUS_MEDIA';
}

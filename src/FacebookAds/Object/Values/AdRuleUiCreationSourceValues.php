...
class AdRuleUiCreationSourceValues extends AbstractEnum {
  ...
  const AM_AUTO2_INTERNAL = 'AM_AUTO2_INTERNAL';
  ...
  const AM_TABLE_MORE_RULES_DROPDOWN = 'AM_TABLE_MORE_RULES_DROPDOWN';
  ...
  const RULES_RECOMMENDED_RULES_DIALOG = 'RULES_RECOMMENDED_RULES_DIALOG';

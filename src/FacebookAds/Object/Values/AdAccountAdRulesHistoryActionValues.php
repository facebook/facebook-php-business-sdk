 ...
 *
 * @method static AdAccountAdRulesHistoryActionValues getInstance()
 */
class AdAccountAdRulesHistoryActionValues extends AbstractEnum {
  ...
  const ENABLE_PIXELLESS_LPV_OPTIMIZATION_GOAL = 'ENABLE_PIXELLESS_LPV_OPTIMIZATION_GOAL';
  ...
  const ENABLE_SHOPS_ADS_SAOFF = 'ENABLE_SHOPS_ADS_SAOFF';
  const ENABLE_WTWA_UPSELL_IN_DUPLICATION = 'ENABLE_WTWA_UPSELL_IN_DUPLICATION';

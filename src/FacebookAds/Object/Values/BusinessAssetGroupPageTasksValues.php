 ...
 *
 * @method static BusinessAssetGroupPageTasksValues getInstance()
 */
class BusinessAssetGroupPageTasksValues extends AbstractEnum {
  ...
  const PROFILE_PLUS_CREATIVE_MANAGEMENT = 'PROFILE_PLUS_CREATIVE_MANAGEMENT';
  const PROFILE_PLUS_CREATOR_MANAGEMENT = 'PROFILE_PLUS_CREATOR_MANAGEMENT';
  const PROFILE_PLUS_FACEBOOK_ACCESS = 'PROFILE_PLUS_FACEBOOK_ACCESS';
  const PROFILE_PLUS_FULL_CONTROL = 'PROFILE_PLUS_FULL_CONTROL';
  const PROFILE_PLUS_GLOBAL_STRUCTURE_MANAGEMENT = 'PROFILE_PLUS_GLOBAL_STRUCTURE_MANAGEMENT';

...
use FacebookAds\Object\Fields\HighDemandPeriodFields;
...
class HighDemandPeriod extends AbstractCrudObject {

  /**
   * @return HighDemandPeriodFields
   */
  public static function getFieldsEnum() {
    return HighDemandPeriodFields::getInstance();
  }

  protected static function getReferencedEnums() {
    $ref_enums = array();
    $ref_enums['BudgetValueType'] = HighDemandPeriodBudgetValueTypeValues::getInstance()->getValues();
    return $ref_enums;
  }

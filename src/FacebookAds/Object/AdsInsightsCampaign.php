...
use FacebookAds\Object\Fields\AdsInsightsCampaignFields;
...
class AdsInsightsCampaign extends AbstractCrudObject {

  /**
   * @return AdsInsightsCampaignFields
   */
  public static function getFieldsEnum() {
    return AdsInsightsCampaignFields::getInstance();
  }
  ...
  public function genget(array $fields = array(), array $params = array(), $pending = false) {
    ...
    $request = new ApiRequest(
      ...
      '/insights',
      new AdsInsightsCampaignGet(),
      'EDGE',
      AdsInsightsCampaignGet::getFieldsEnum()->getValues(),

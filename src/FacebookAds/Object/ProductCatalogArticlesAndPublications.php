...
class ProductCatalogArticlesAndPublications extends AbstractCrudObject {
  ...
  public function genpost(array $fields = array(), array $params = array(), $pending = false) {
    ...
    $request = new ApiRequest(
      ...
      new ProductCatalogArticlesAndPublicationsPost(),
      'EDGE',
      ProductCatalogArticlesAndPublicationsPost::getFieldsEnum()->getValues(),

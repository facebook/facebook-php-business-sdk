...
class AdAccount extends AbstractCrudObject
{
    ...
    public function getActivities(
        ...
        return $this->getManyByConnection(Activity::className(), $fields, $params, 'activities');
    }
    ...
    public function getCampaigns(
        ...
        return $this->getManyByConnection(Campaign::className(), $fields, $params);
    }
    ...
    public function getConnectionObjects(
        ...
        return $this->getManyByConnection(ConnectionObject::className(), $fields, $params, 'connectionobjects');
    }
    ...
    public function getConversionPixels(
        ...
        return $this->getManyByConnection(AdConversionPixel::className(), $fields, $params);
    }
    ...
    public function getPartnerCategories(
        ...
        return $this->getManyByConnection(PartnerCategory::className(), $fields, $params);
    }
    ...
    public function getRateCards(
        ...
        return $this->getManyByConnection(RateCard::className(), $fields, $params, 'ratecard');
    }
    ...
    public function getTransactions(
        ...
        return $this->getManyByConnection(Transaction::className(), $fields, $params, 'transactions');
    }
    ...
    public function getAdPreviews(
        ...
        return $this->getManyByConnection(AdPreview::classname(), $fields, $params, 'generatepreviews');
    }
    ...
    public function getMinimumBudgets(
        ...
        return $this->getManyByConnection(MinimumBudget::className(), $fields, $params, 'minimum_budgets');
    }
    ...
    public function getAdPlacePageSets(
        ...
        return $this->getManyByConnection(AdPlacePageSet::className(), $fields, $params);
    }
    ...
    public function getAdSetsByLabel(
        ...
        return $this->getManyByConnection(AdSet::classname(), $fields, $params, 'adsetsbylabels');
    }
    ...
    public function getAdCreativesByLabel(
        ...
        return $this->getManyByConnection(AdCreative::classname(), $fields, $params, 'adcreativesbylabels');
    }
    ...
    public function getCustomConversions(
        ...
        return $this->getManyByConnection(CustomConversion::className(), $fields, $params);
    }
}

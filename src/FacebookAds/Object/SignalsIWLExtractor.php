...
class SignalsIWLExtractor extends AbstractCrudObject {
  ...
  protected static function getReferencedEnums() {
    $ref_enums = array();
    $ref_enums['EventType'] = SignalsIWLExtractorEventTypeValues::getInstance()->getValues();
    $ref_enums['ExtractorType'] = SignalsIWLExtractorExtractorTypeValues::getInstance()->getValues();
    return $ref_enums;
  }

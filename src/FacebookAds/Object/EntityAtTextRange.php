...
use FacebookAds\Object\Fields\EntityAtTextRangeFields;
use FacebookAds\Object\Values\EntityAtTextRangeTypeValues;
...
class EntityAtTextRange extends AbstractCrudObject {
  ...
  public function getSelf(array $fields = array(), array $params = array(), $pending = false) {
    ...
    $request = new ApiRequest(
      ...
      '/',
      new EntityAtTextRange(),
      'NODE',
      EntityAtTextRange::getFieldsEnum()->getValues(),

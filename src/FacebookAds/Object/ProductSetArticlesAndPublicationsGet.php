...
use FacebookAds\Object\Values\ProductSetArticlesAndPublicationsGetDisplayFormatValues;
...
class ProductSetArticlesAndPublicationsGet extends AbstractObject {
  ...
  protected static function getReferencedEnums() {
    $ref_enums = array();
    $ref_enums['DisplayFormat'] = ProductSetArticlesAndPublicationsGetDisplayFormatValues::getInstance()->getValues();
    return $ref_enums;
  }

...
use FacebookAds\Object\Fields\ProductDaEventSamplesBatchFields;
...
class ProductDaEventSamplesBatch extends AbstractCrudObject {
  ...
  public static function getFieldsEnum() {
    return ProductDaEventSamplesBatchFields::getInstance();
  }

  protected static function getReferencedEnums() {
    $ref_enums = array();
    $ref_enums['AggregationType'] = ProductDaEventSamplesBatchAggregationTypeValues::getInstance()->getValues();
    $ref_enums['Event'] = ProductDaEventSamplesBatchEventValues::getInstance()->getValues();
    return $ref_enums;
  }
